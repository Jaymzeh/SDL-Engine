...
enum Orientation {
	NORMAL, MIRROR_X, MIRROR_Y, ROT_90, ROT_180, ROT_270
};
...
private:
	...
	void drawTexture(float tex_x1, float tex_y1, float text_x2, float tex_y2, int scr_x1, int scr_y1, int scr_x2, int scr_y2);
	void allocateMem();
